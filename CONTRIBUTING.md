...
1. Fork the repo: https://github.com/TheBestTvarynka/grafily/fork.
2. Make changes and commit them to your development branch.
3. Push commits to your repo.
...
1. Run `npx prettier . --write` periodically.
2. Run `npx eslint .` periodically.

## What to contribute?

If you want to implement a missing/wanting feature, then create an issue, discuss it with maintainer(s), get approval, and start working on it.

If you want to fix a bug, then create an issue, discuss possible solutions with maintainer(s), get approval, and start fixing it.

If you don't know what to implement, then you can browse [existing issues](https://github.com/TheBestTvarynka/grafily/issues?q=sort%3Aupdated-desc+is%3Aissue+is%3Aopen) or ask for help. We always have something to do :stuck_out_tongue_winking_eye:.
